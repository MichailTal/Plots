...
plot(contTime, household_power_consumption$Voltage, type = 'l', xlab = 'datetime', ylab = 'Voltage')
...
plot(contTime, household_power_consumption$Global_reactive_power, type = 'l', xlab = 'datetime', ylab = 'Global_reactive_power')
